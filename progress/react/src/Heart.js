...
export const Heart = ({ percent=100, size=24, color, style, ...props }) => (
  <svg height={`${size}px`} width={`${size}px`} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 24 24" style={Object.assign({enableBackground: 'new 0 0 24 24', xmlSpace:"preserve"},style)} {...props}>
