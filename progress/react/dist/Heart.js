...
var Heart = /** @class */ (function (_super) {
    ...
    Heart.prototype.render = function () {
        var _a = __assign(__assign({}, utilities_1.defaultProps), this.props), outlined = _a.outlined, size = _a.size, percent = _a.percent, color = _a.color, charging = _a.charging, props = __rest(_a, ["outlined", "size", "percent", "color", "charging"]);
