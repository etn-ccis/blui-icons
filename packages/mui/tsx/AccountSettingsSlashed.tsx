...
const SvgAccountSettingsSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="account_settings_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#account_settings_slashed_svg__a)">
    ...
    'SvgAccountSettingsSlashed'
);
export default SvgAccountSettingsSlashed;
