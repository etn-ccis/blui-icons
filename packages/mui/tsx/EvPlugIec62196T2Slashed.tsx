...
const SvgEvPlugIec62196T2Slashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="ev_plug_iec_62196_t2_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#ev_plug_iec_62196_t2_slashed_svg__a)">
    ...
    'SvgEvPlugIec62196T2Slashed'
);
export default SvgEvPlugIec62196T2Slashed;
