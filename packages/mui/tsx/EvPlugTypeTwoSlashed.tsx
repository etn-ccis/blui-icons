...
const SvgEvPlugTypeTwoSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="ev_plug_type_two_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#ev_plug_type_two_slashed_svg__a)">
    ...
    'SvgEvPlugTypeTwoSlashed'
);
export default SvgEvPlugTypeTwoSlashed;
