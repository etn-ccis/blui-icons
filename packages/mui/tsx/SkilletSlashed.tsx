...
const SvgSkilletSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="skillet_slashed_svg__a">
                <path
