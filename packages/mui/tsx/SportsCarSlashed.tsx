...
const SvgSportsCarSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="sports_car_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#sports_car_slashed_svg__a)">
...
export default SvgSportsCarSlashed;
