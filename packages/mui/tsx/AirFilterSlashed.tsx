...
const SvgAirFilterSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="air_filter_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#air_filter_slashed_svg__a)">
...
export default SvgAirFilterSlashed;
