...
const SvgHostOutlineSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="host_outline_slashed_svg__a">
                <path
