...
const SvgBarleyAltSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="barley_alt_slashed_svg__a">
                <path
