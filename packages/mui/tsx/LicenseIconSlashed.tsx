...
const SvgLicenseIconSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="license_icon_slashed_svg__a">
                <path
