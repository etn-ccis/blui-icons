...
const SvgHopsSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="hops_slashed_svg__a">
                <path
