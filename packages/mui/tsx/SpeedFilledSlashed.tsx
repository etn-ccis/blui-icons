...
const SvgSpeedFilledSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="speed_filled_slashed_svg__a">
                <path
