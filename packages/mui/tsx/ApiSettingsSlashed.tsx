...
const SvgApiSettingsSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="api_settings_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#api_settings_slashed_svg__a)">
    ...
    'SvgApiSettingsSlashed'
);
export default SvgApiSettingsSlashed;
