...
const SvgPowerFactorSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="power_factor_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#power_factor_slashed_svg__a)">
    ...
    'SvgPowerFactorSlashed'
);
export default SvgPowerFactorSlashed;
