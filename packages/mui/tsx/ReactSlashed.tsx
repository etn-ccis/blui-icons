...
const SvgReactSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="react_slashed_svg__a">
                <path
