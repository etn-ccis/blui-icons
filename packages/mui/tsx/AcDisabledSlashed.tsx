...
const SvgAcDisabledSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="ac_disabled_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#ac_disabled_slashed_svg__a)">
    ...
    'SvgAcDisabledSlashed'
);
export default SvgAcDisabledSlashed;
