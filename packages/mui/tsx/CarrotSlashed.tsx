...
const SvgCarrotSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="carrot_slashed_svg__a">
                <path
...
export default SvgCarrotSlashed;
