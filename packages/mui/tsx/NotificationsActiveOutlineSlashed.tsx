...
const SvgNotificationsActiveOutlineSlashed = createSvgIcon(
    React.createElement(
        React.Fragment,
        {},
        <defs>
            <clipPath id="notifications_active_outline_slashed_svg__a">
                <path
        ...
        <g clipPath="url(#notifications_active_outline_slashed_svg__a)">
    ...
    'SvgNotificationsActiveOutlineSlashed'
);
export default SvgNotificationsActiveOutlineSlashed;
